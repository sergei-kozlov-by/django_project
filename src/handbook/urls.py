...
urlpatterns = [
    ...
    path('serie_<int:pk>/', views.SerieDetail.as_view(), name="serie-view"),
    ...
    path('genre_<int:pk>/', views.GenreDetail.as_view(), name="genre-view"),
    ...
    path('publisher_<int:pk>/', views.PublisherDetail.as_view(), name="publisher-view"),
